...
{
    [Fact]
    public void SaveUsersToFile_ShouldCreateFileWithUsers() //testar att den fileservice faktiskt sparar ner en User till filen.  GrundStruktur genererad av CHATGPT. Clean är copypastad. 
    {
        //arrange
